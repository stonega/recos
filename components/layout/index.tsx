...
const Layout = ({ children, meta }: LayoutProps) => {
  ...
  return (
    <>
      ...
      />
      <div className="relative flex min-h-screen w-full flex-col items-center bg-gradient-to-b from-white to-green-100 from-70% to-90% dark:from-[#101010] dark:to-[#062813]">
        <NavBar></NavBar>
